            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4) {
                    if (xhr.status === 200) {
                        ...
                        // Verarbeite die XML-Daten und filtere nach dem Suchbegriff
                        ...
                        for (var i = 0; i < automobiles.length; i++) {
                            ...
                            // Überprüfen, ob die Marke oder das Modell dem Suchbegriff entsprechen
                            if (marke.includes(searchTerm) || modell.includes(searchTerm)) {
                                var result = {
                                    Marke: marke,
                                    Modell: modell
                                };
